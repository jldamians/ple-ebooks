...
describe('Prototype Sale.js', function() {
  ...
  it('Exempt invoice (Exonerado)', function() {
    ...
    assert.equal(newSale.getText(), '20190100|1|M-RER|01/01/2019||01|F001|1||6|20547872518|EASY TAXI PERÚ S.A.C.||||||100.00||||||100.00|PEN|1.000|||||||1|1|')
  })
  ...
  it('Non taxable invoice (Inafecto)', function() {
    ...
    assert.equal(newSale.getText(), '20190100|2|M-RER|02/01/2019||01|F001|2||6|20547872518|EASY TAXI PERÚ S.A.C.|||||||100.00|||||100.00|PEN|1.000|||||||1|1|')
  })
  ...
  it('Taxable invoice (Gravado)', function() {
    ...
    assert.equal(newSale.getText(), '20190100|3|M-RER|03/01/2019||01|F001|3||6|20547872518|EASY TAXI PERÚ S.A.C.||100.00||18.00||||||||118.00|PEN|1.000|||||||1|1|')
  })
  ...
  it('Taxable credit note (Gravado). Invoice issued the previous period', function() {
    ...
    assert.equal(newSale.getText(), '20190100|1|M-RER|01/01/2019||07|F001|1||6|20547872518|EASY TAXI PERÚ S.A.C.|||-100.00||-18.00|||||||118.00|PEN|1.000|01/12/2018|01|F001|1|||1|1|')
  })
  ...
  it('Taxable credit note (Gravado). Invoice issued the same period', function() {
    ...
    assert.equal(newSale.getText(), '20190100|1|M-RER|10/01/2019||07|F001|2||6|20547872518|EASY TAXI PERÚ S.A.C.||100.00||18.00||||||||118.00|PEN|1.000|05/01/2019|01|F001|2|||1|1|')
  })
})
