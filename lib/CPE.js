  ...
  Object.defineProperty(this, 'issuanceDate', {
    get: () => {
      ...
      if (isValidIssuanceDate) {
        ...
        throw new Error(
          `La fecha de emisión del CPE ${this.type}-${this.serial}-${this.number} es incorrecta`
        )
      }
    },
  })
    ...
    get: () => {
      ...
      if (_args.expirationDate != null) {
        ...
        if (isValidExpirationDate) {
          ...
          throw new Error(
            `La fecha de expiración del CPE ${this.type}-${this.serial}-${this.number} es incorrecta`
          )
        }
      } else {
        return ''
